...
docker run -i --rm --name ${docker_name} \
           ...
           'export https_proxy_tmp=${https_proxy}
            ...
            cmake .. -DFASTDEPLOY_DIR=/workspace/fastdeploy/build/fastdeploy_install -DTRITON_COMMON_REPO_TAG=r23.12 -DTRITON_CORE_REPO_TAG=r23.12 -DTRITON_BACKEND_REPO_TAG=r23.12;
            make -j`nproc`'
